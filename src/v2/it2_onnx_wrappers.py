"""PyTorch wrappers for IndicTrans2 ONNX export (naklitechie I/O layout) - V2."""
...
class IndicTransDecoderWithPastWrapper(nn.Module):
    ...
    def __init__(self, decoder: nn.Module, lm_head: nn.Module, num_layers: int, embed_dim: int) -> None:
        super().__init__()
        self.decoder = decoder
        self.lm_head = lm_head
