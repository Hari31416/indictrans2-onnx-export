#!/usr/bin/env python3
"""Run 05_upload_hf.py in dry-run mode for all 12 model bundles to generate README.md and copy plots."""
...
def main():
    ...
    for direction, repo_base in DIRECTIONS.items():
        for precision in PRECISIONS:
            ...
            folder_name = f"{direction}-onnx{precision_suffix}"
            ...
            cmd = [
                ".venv/bin/python", "src/05_upload_hf.py",
